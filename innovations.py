...
if selection == "Career Highlights":
     ...
     st.write("I teach 3-4 sections of courses, per semester, across the Mechanical engineering curriculum. Through the courses I teach, I engage 150-250 students across a Mechanical Engineering curriculum in a year. Since 2019, I have begun to shed a traditional classroom (inert lecturing -- which I found to be ineffective for large enrollments) approach in favour of the inverted classroom, emphasis on 1-on-1 time, and collaborative design studios.")
