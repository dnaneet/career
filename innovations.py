...
year_items = df['Year']
x = st.sidebar.selectbox('Select Year', np.unique(year_items) , key = "innovations")
...
st.subheader("Teaching Evaluation Scores")
...
st.subheader('Summary of instructional innovations & scholarly outcomes')
...
st.subheader('Nomination for Instructional Awards')
